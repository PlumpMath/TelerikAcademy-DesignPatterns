...
namespace Dealership.Models
{
    public class Truck : Vehicle, ITruck
    {
        ...
        {
            Validator.ValidateIntRangeExclusive(this.weightCapacity, Constants.MinCapacity, Constants.MaxCapacity, string.Format(Constants.NumberMustBeBetweenMinAndMax, WeightCapacityPropery, Constants.MinCapacity, Constants.MaxCapacity));
        }
    }
}
