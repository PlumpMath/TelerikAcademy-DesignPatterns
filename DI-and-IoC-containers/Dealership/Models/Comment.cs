...
namespace Dealership.Models
{
    public class Comment : IComment
    {
        ...
        private void ValidateFields()
        {
            ...
            Validator.ValidateIntRangeExclusive(this.content.Length, Constants.MinCommentLength, Constants.MaxCommentLength, string.Format(Constants.StringMustBeBetweenMinAndMax, ContentProperty, Constants.MinCommentLength, Constants.MaxCommentLength));
        }
    }
}
