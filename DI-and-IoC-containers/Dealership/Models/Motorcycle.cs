...
namespace Dealership.Models
{
    public class Motorcycle : Vehicle, IMotorcycle
    {
        ...
        private void ValidateFields()
        {
            ...
            Validator.ValidateIntRangeExclusive(this.category.Length, Constants.MinCategoryLength, Constants.MaxCategoryLength, string.Format(Constants.StringMustBeBetweenMinAndMax, CategoryProperty, Constants.MinCategoryLength, Constants.MaxCategoryLength));
        }
    }
}
